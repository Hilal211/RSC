...
class Testimonials extends Post_Type {
	...
	public static function init() {
		self::instance()->menu_name = esc_html__( 'Testimonials',  'buildexo-plugin' );
		self::instance()->singular  = esc_html__( 'Testimonial',  'buildexo-plugin' );
		self::instance()->plural    = esc_html__( 'Testimonials',  'buildexo-plugin' );
