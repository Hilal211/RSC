 ...
 * @since 1.0.0
 */
class Project_Carousel_Two extends Widget_Base {
	/**
	 * Get widget name.
	...
	public function get_name() {
		return 'turner_project_carousel_two';
	}
	/**
	 * Get widget title.
	...
	public function get_title() {
		return esc_html__( 'Turner Project Carousel Two', 'turner' );
	}
	/**
	 * Get widget icon.
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'placeholder' => esc_html__( 'Category', 'turner' ),						
			]
		);
	...
	*************************************************************************/
	...
	protected function render() {
	 ...
	 <div class="projects-one">
        <div class="project-one_carousel">
                        ...
                        <div class="project-block_one-inner">
                            <div class="project-block_one-image">
                                ...
                                <div class="project-block_one-content">
                                    <h5 class="project-block_one-heading"><a href="<?php echo esc_url($item['link']['url']);?>"><?php echo esc_html($item['title']);?></a></h5>
                                    <div class="project-block_one-designation"><?php echo esc_html($item['title']);?></div>
                                    <a class="project-block_one-arrow" href="<?php echo esc_url($item['link']['url']);?>">
                                        <?php if(!empty($settings['arrow']['url'])):?>
                                            <img src="<?php echo esc_url($settings['arrow']['url']);?>" alt="" />
                                        <?php endif;?>
                                    </a>
                                </div>
                            </div>
