...
get_header();
global $wp_query;
$data  = \buildexo\Includes\Classes\Common::instance()->data( 'category' )->get();
...
<!-- breadcrumb start -->
<section class="breadcrumb bg_img d-flex align-items-center" data-overlay="dark-2" data-opacity="8" data-background="<?php echo esc_url( $data->get( 'category_page_banner' ) ); ?>">
    <div class="container">
