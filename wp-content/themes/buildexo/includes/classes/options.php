...
class Options {
	...
	function args() {
		...
		$args = array(
			...
			'global_variable'      => 'turner_options',
		...
		$args['share_icons'][] = array(
			...
			'url'   => 'https://www.pinterest.com/thegenious_/',
		...
		$args['share_icons'][] = array(
			...
			'url'   => 'https://www.facebook.com/people/@/thegenious',
		...
		$args['share_icons'][] = array(
			...
			'url'   => 'https://twitter.com/thegenious',
		...
		$args['share_icons'][] = array(
			...
			'url'   => 'https://www.linkedin.com/company/thegenious-web-arcade',
	...
	function helpTabs() {
		...
		$tabs = array(
			...
			array(
				...
				'title'   => esc_html__( 'Theme Information 1', 'buildexo' ),

				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'buildexo' ),
			...
			array(
				...
				'title'   => esc_html__( 'Theme Information 2', 'buildexo' ),
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'buildexo' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'turner_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "turner_redux_sections_{$key}", $options );
