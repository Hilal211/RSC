...
get_header();
global $wp_query;
$data  = \buildexo\Includes\Classes\Common::instance()->data( 'tag' )->get();
...
<!-- breadcrumb start -->
<section class="breadcrumb bg_img d-flex align-items-center" data-overlay="dark-2" data-opacity="8" data-background="<?php echo esc_url( $data->get( 'tag_page_background' ) ); ?>">
    <div class="container">
...
<section class="blog pt-120 pb-120">
    <div class="container">
        <div class="row mt-none-30">
			...
			?>
            <div class="content-side <?php echo esc_attr( $class ); ?> mt-30">
