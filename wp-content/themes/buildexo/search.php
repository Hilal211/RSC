...
get_header();
global $wp_query;
$data  = \buildexo\Includes\Classes\Common::instance()->data( 'search' )->get();
...
<!-- breadcrumb start -->
<section class="breadcrumb bg_img d-flex align-items-center" data-overlay="dark-2" data-opacity="8" data-background="<?php echo esc_url( $data->get( 'search_page_banner' ) ); ?>">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="content-side <?php echo esc_attr( $class ); ?>">
                ...
                <div class="search-notfound">
                    <p class="mb-20"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'buildexo' ); ?></p>
                    <div class="sidebar-side">
                        <div class="sidebar sticky-top cus-search-tp">
                            <?php get_search_form() ?>
                        </div>
                    </div>
                </div>
